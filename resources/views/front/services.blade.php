...
@section('content')
            ...
            <script type="application/ld+json">
    {
        ...
        <!-- Start Bradcaump area -->
            <div class="pt--90">
                <picture>
                    <source type="image/webp" srcset="{{asset('images/banner/dich-vu.webp')}}">
                    <source type="image/jpeg" srcset="{{asset('images/banner/dich-vu.jpg')}}">
                    <img src="{{asset('images/banner/dich-vu.jpg')}}" alt="dịch vụ cho thuê máy photocopy, sửa chữa máy in tận nơi" />
                </picture>
            </div>
            <!-- End Bradcaump area -->
            <!-- Start Blog Area -->
